...
"{:10}".format("test")                                # "test      " (10 spaces)
"{:^10}".format("test")                               # "   test   " (centered)
"{:>10}".format("test")                               # "      test" (right-aligned)
"{:<10}".format("test")                               # "test      " (left-aligned)
...
# 4 - finding the first occurrence of the substring
...
# 5 - checking string type methods
"HELLO".isupper()                                     # True
"hello".islower()                                     # True
"   ".isspace()                                       # True
"abc".isalpha()                                       # True
